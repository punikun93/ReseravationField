<header class="bg-white">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="/class" class="text-sm font-semibold leading-6 text-gray-900">Features</a>
        <a href="/siswa" class="text-sm font-semibold leading-6 text-gray-900">Siswa</a>
        <a href="/product" class="text-sm font-semibold leading-6 text-gray-900">Produk</a>
        <a href="/latihan" class="text-sm font-semibold leading-6 text-gray-900">About</a>
      </div>
